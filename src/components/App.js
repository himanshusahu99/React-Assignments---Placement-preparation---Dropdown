...
function App() {
  ...
  const [curretStateIndex, setCurretnStateIndex] = useState(0);
    ...
    <div id="main">
      ...
      >
        {states.map((element, index) => {
          return (
            <>
              <option key={element.name} value={index}>
                {element.name}
              </option>
            </>
          );
      ...
      >
        {states[curretStateIndex].city.map((element, index) => {
          return (
            <>
              <option key={element.name} value={index}>
                {element.name}
      ...
      >
        {states[curretStateIndex].city[cityindex].landmarks.map(
          (element, index) => {
            return (
              <>
                <option key={element.name} value={index}>
